...
class TestUserService(BaseTestCase):
    ...
    def test_add_single_user(self):
        ...
        with self.client:
            ...
            self.assertIn('michael@mherman', data['data']['email'])
            self.assertIn('success', data['status'])
    ...
    def test_all_users(self):
        ...
        with self.client:
            ...
            self.assertIn(
                'michael', data['data']['users'][0]['username']
            )
            self.assertIn(
    ...
    def test_single_user_incorrect_id(self):
        """Ensure error is thrown if the id doest not exists"""
        with self.client:
